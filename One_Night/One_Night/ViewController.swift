...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    struct gobal {
        static var loadImage:Int = 0
        static var loadImage2:Int = 0
        static var loadImage3:Int = 0
        static var loadImage4:Int = 0
        static var ArrayList = Array<String>()
    }
    
    
    var clickOfPlay:Int = 0
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row == 0 {
            ...
            for person in doppelganger{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("doppelganger.png", atIndex: 0)
        ...
        if indexPath.row == 1 {
            ...
            for person in werewolf{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("werewolf.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        if indexPath.row == 3 {
            ...
            for person in minion{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("Minion.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        if indexPath.row == 4 {
            ...
            for person in mason{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("mason.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        if indexPath.row == 6 {
            ...
            for person in seer{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("seer.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        if indexPath.row == 7 {
            ...
            for person in robber{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("robber.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        if indexPath.row == 8 {
            ...
            for person in troublemaker{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("troublemaker.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        if indexPath.row == 9 {
            ...
            for person in drunk{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("drunk.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        if indexPath.row == 10 {
            ...
            for person in insomiac{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("insomniac.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        if indexPath.row == 11 {
            ...
            for person in villager{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("villager.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        if indexPath.row == 14 {
            ...
            for person in hunter{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("hunter.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        if indexPath.row == 15 {
            ...
            for person in tanner{
                if(person.countClick % 2 == 0){
                    ...
                    gobal.ArrayList.insert("tanner.png", atIndex: 0)
                    cell.layer.borderWidth = 0.5
                    cell.layer.borderColor = UIColor.whiteColor().CGColor
                    cell.alpha = 1
        ...
        print("xxx: \(gobal.ArrayList.count)")
        return cell
    }
    ...
    func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
                ...
                try! realm.write{
                    for person in doppelganger{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("doppelganger.png")!)
                ...
                try! realm.write{
                    for person in werewolf{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("werewolf.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
                ...
                try! realm.write{
                    for person in minion{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("Minion.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
                ...
                try! realm.write{
                    for person in mason{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("mason.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
                ...
                try! realm.write{
                    for person in seer{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("seer.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
                ...
                try! realm.write{
                    for person in robber{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("robber.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
                ...
                try! realm.write{
                    for person in troublemaker{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("troublemaker.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
                ...
                try! realm.write{
                    for person in drunk{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("drunk.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
                ...
                try! realm.write{
                    for person in insomiac{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("insomniac.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
                ...
                try! realm.write{
                    for person in villager{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("villager.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
                ...
                try! realm.write{
                    for person in hunter{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("hunter.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
                ...
                try! realm.write{
                    for person in tanner{
                        ...
                        if(person.countClick % 2 == 0){
                            ...
                            gobal.ArrayList.removeAtIndex(gobal.ArrayList.indexOf("tanner.png")!)
                            cell.layer.borderWidth = 0
                            cell.layer.borderColor = UIColor.whiteColor().CGColor
                            cell.alpha = 0.4
        ...
        print("aaa:\(gobal.ArrayList.count))")
    ...
    //setBoardView
    func setBoardView(){
        boardView = BoardView(frame:CGRect(x: self.vContact.bounds.origin.x,y: self.vContact.bounds.origin.y,width: self.vContact.bounds.size.width,height: self.vContact.bounds.size.height))
        boardView.btn1.addTarget(self, action: #selector(ViewController.loadImage(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        boardView.btn2.addTarget(self, action: #selector(ViewController.loadImage2(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        boardView.btn3.addTarget(self, action: #selector(ViewController.loadImage3(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        boardView.btn4.addTarget(self, action: #selector(ViewController.loadImage4(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        boardView.tag = 9999
        self.vContact.addSubview(boardView)
    }
    
    func loadImage(sender:UIButton){
        gobal.loadImage += 1
        ...
        print("xxx")
        boardView.btn1.enabled = false
        
        
    }
    
    func loadImage2(sender:UIButton){
        gobal.loadImage2 += 1
        if UIImagePickerController.isSourceTypeAvailable(UIImagePickerControllerSourceType.SavedPhotosAlbum){
            print("Button capture")
        ...
        print("yyy")
        boardView.btn2.enabled = false
    }
    
    func loadImage3(sender:UIButton){
        gobal.loadImage3 += 1
        if UIImagePickerController.isSourceTypeAvailable(UIImagePickerControllerSourceType.SavedPhotosAlbum){
            print("Button capture")
        ...
        print("zzz")
        boardView.btn3.enabled = false
    }
    
    func loadImage4(sender:UIButton){
        gobal.loadImage4 += 1
        if UIImagePickerController.isSourceTypeAvailable(UIImagePickerControllerSourceType.SavedPhotosAlbum){
            print("Button capture")
    ...
    func imagePickerController(picker: UIImagePickerController!, didFinishPickingImage image: UIImage!, editingInfo: NSDictionary!){
        ...
        if gobal.loadImage == 1 {
            boardView.back.image = image
            if boardView.btn2.enabled {
                boardView.btn2.enabled = false
            }
            boardView.view_2.userInteractionEnabled = false
            if boardView.btn3.enabled {
                boardView.btn3.enabled = false
            }
            boardView.view_3.userInteractionEnabled = false
            if boardView.btn4.enabled {
                boardView.btn4.enabled = false
            }
            boardView.view_4.userInteractionEnabled = false
            gobal.loadImage = 2
            return
        }
        if gobal.loadImage2 == 1 {
            boardView.back2.image = image
            if boardView.btn1.enabled {
                boardView.btn1.enabled = false
            }
            if boardView.btn3.enabled {
                boardView.btn3.enabled = false
            ...
            boardView.view_4.userInteractionEnabled = false
            boardView.view_3.userInteractionEnabled = false
            boardView.view_1.userInteractionEnabled = false
            gobal.loadImage2 = 2
            return
        }
        if gobal.loadImage3 == 1 {
            boardView.back3.image = image
            if boardView.btn1.enabled {
                boardView.btn1.enabled = false
            }
            boardView.view_1.userInteractionEnabled = false
        ...
        if gobal.loadImage4 == 1 {
            boardView.back4.image = image
            if boardView.btn1.enabled {
                boardView.btn1.enabled = false
            }
            boardView.view_1.userInteractionEnabled = false
    ...
    @IBAction func ClickSetting(sender: AnyObject) {
        ...
        if clickOfPlay == 1
        {
            let viewwithTag9999 = self.view.viewWithTag(9999)
            if (viewwithTag9999 != nil){
                viewwithTag9999!.hidden = true
            }
        }
    ...
    func ReleadSubView(sender:UIButton){
        ...
        if clickOfPlay == 1 {
            ...
            let viewwithTag = self.view.viewWithTag(100)
            let viewwithTag2 = self.view.viewWithTag(101)
            let viewwithTag3 = self.view.viewWithTag(9999)
            if (viewwithTag != nil && viewwithTag2 != nil){
                viewwithTag!.hidden = true
                viewwithTag2!.hidden = true
                viewwithTag3!.hidden = false
